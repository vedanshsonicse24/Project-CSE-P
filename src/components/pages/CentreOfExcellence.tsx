...
export default function CentreOfExcellence() {
  ...
  return (
    <div style={{ background: BG_LIGHT, minHeight: '100vh', fontFamily: 'Poppins, Inter, sans-serif' }}>
      ...
      {/* 10. CONTACT */}
      <section className="py-20 px-6" style={{ background: '#f8fafc', borderTop: `1px solid rgba(0, 188, 212, 0.1)` }}>
        <div className="max-w-7xl mx-auto">
          <motion.h2
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <motion.p
            ...
            transition={{ duration: 0.8, delay: 0.2 }}
            viewport={{ once: true }}
            className="text-center text-gray-600 mb-12 text-base md:text-lg"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            >
              <h3 className="text-xl md:text-2xl font-bold mb-6 md:mb-8" style={{ color: PRIMARY }}>Send us a message</h3>
              <form className="space-y-4 md:space-y-6">
                <input
                  type="text"
                  placeholder="Your Name"
                  className="w-full px-3 md:px-4 py-2 md:py-3 rounded-lg border border-gray-300 focus:outline-none focus:border-cyan-500 text-sm md:text-base"
                />
                <input
                  type="email"
                ...
                <button
                  type="submit"
                  className="w-full rounded-full h-10 md:h-12 py-2 md:py-3 text-white font-bold tracking-wide transition-all hover:scale-105 flex items-center justify-center text-sm md:text-base"
                  style={{ background: ACCENT }}
                >
                  Send Message
                </button>
            ...
            >
              <div className="bg-white rounded-2xl p-4 md:p-6 shadow-lg flex items-start gap-3 md:gap-4">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: `${ACCENT}20` }}>
                  <MapPin size={20} color={ACCENT} className="md:w-6 md:h-6" />
                </div>
                <div>
                  <h4 className="font-bold mb-1 text-sm md:text-base" style={{ color: PRIMARY }}>Address</h4>
                  <p className="text-gray-600 text-xs md:text-sm">SSIPMT, Old Dhamtari Road, Sejbahar, Raipur – 492015</p>
                </div>
              </div>

              <div className="bg-white rounded-2xl p-4 md:p-6 shadow-lg flex items-start gap-3 md:gap-4">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: `${ACCENT}20` }}>
                  <Mail size={20} color={ACCENT} className="md:w-6 md:h-6" />
                </div>
                <div>
                  <h4 className="font-bold mb-1 text-sm md:text-base" style={{ color: PRIMARY }}>Email</h4>
                  <p className="text-gray-600 text-xs md:text-sm">coe@ssipmt.edu</p>
                </div>
              </div>

              <div className="bg-white rounded-2xl p-4 md:p-6 shadow-lg flex items-start gap-3 md:gap-4">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: `${ACCENT}20` }}>
                  <Phone size={20} color={ACCENT} className="md:w-6 md:h-6" />
                </div>
                <div>
                  <h4 className="font-bold mb-1 text-sm md:text-base" style={{ color: PRIMARY }}>Phone</h4>
                  <p className="text-gray-600 text-xs md:text-sm">+91-771-3501600</p>
                </div>
              </div>

              {/* Social Links */}
              <div className="bg-white rounded-2xl p-4 md:p-6 shadow-lg">
                <h4 className="font-bold mb-3 md:mb-4 text-sm md:text-base" style={{ color: PRIMARY }}>Follow Us</h4>
                <div className="flex gap-3 md:gap-4">
                  <a href="#" className="w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center transition-all hover:scale-110" style={{ background: PRIMARY }}>
                    <Linkedin size={20} color="white" className="md:w-6 md:h-6" />
                  </a>
                  <a href="#" className="w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center transition-all hover:scale-110" style={{ background: PRIMARY }}>
                    <Instagram size={20} color="white" className="md:w-6 md:h-6" />
                  </a>
                  <a href="#" className="w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center transition-all hover:scale-110" style={{ background: PRIMARY }}>
                    <Github size={20} color="white" className="md:w-6 md:h-6" />
                  </a>
                </div>
              </div>
            </motion.div>
      ...
      {/* FOOTER */}
      <footer className="py-12 md:py-16 px-6 text-white" style={{ background: PRIMARY }}>
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            {/* About Section */}
            <div>
              <div className="flex items-center gap-3 mb-4">
                <Rocket size={28} color={ACCENT} className="md:w-8 md:h-8" />
                <div>
                  <p className="font-bold text-base md:text-lg">Centre of Excellence</p>
                  <p className="text-xs md:text-sm text-gray-400">SSIPMT Raipur</p>
                </div>
              </div>
              <p className="text-sm text-gray-400 mb-4">
                Empowering students through innovation, real-world projects, and cutting-edge technology.
              </p>
            </div>

            {/* Quick Links */}
            <div>
              <h4 className="font-bold text-lg mb-4" style={{ color: ACCENT }}>Quick Links</h4>
              <ul className="space-y-2">
                <li><a href="#" className="text-sm text-gray-300 hover:text-cyan-400 transition-colors">WHO WE ARE</a></li>
                <li><a href="#" className="text-sm text-gray-300 hover:text-cyan-400 transition-colors">EDUCATION & RESEARCH</a></li>
                <li><a href="#" className="text-sm text-gray-300 hover:text-cyan-400 transition-colors">CSE PROGRAMS</a></li>
                <li><a href="#" className="text-sm text-gray-300 hover:text-cyan-400 transition-colors">ADMISSIONS</a></li>
              </ul>
            </div>

            {/* Campus Life */}
            <div>
              <h4 className="font-bold text-lg mb-4" style={{ color: ACCENT }}>Campus Life</h4>
              <ul className="space-y-2">
                <li><a href="#" className="text-sm text-gray-300 hover:text-cyan-400 transition-colors">NEWS & EVENTS</a></li>
                <li><a href="#" className="text-sm text-gray-300 hover:text-cyan-400 transition-colors">CLUBS</a></li>
                <li><a href="#" className="text-sm text-gray-300 hover:text-cyan-400 transition-colors">PEOPLE</a></li>
                <li><a href="#" className="text-sm text-gray-300 hover:text-cyan-400 transition-colors">VIRTUAL TOUR</a></li>
              </ul>
            </div>

            {/* Contact */}
            <div>
              <h4 className="font-bold text-lg mb-4" style={{ color: ACCENT }}>Contact Info</h4>
              <div className="space-y-3">
                <div className="flex items-start gap-2">
                  <MapPin size={16} color={ACCENT} className="mt-1 flex-shrink-0" />
                  <p className="text-sm text-gray-300">SSIPMT, Old Dhamtari Road, Sejbahar, Raipur – 492015</p>
                </div>
                <div className="flex items-center gap-2">
                  <Phone size={16} color={ACCENT} className="flex-shrink-0" />
                  <p className="text-sm text-gray-300">+91-771-3501600</p>
                </div>
                <div className="flex items-center gap-2">
                  <Mail size={16} color={ACCENT} className="flex-shrink-0" />
                  <p className="text-sm text-gray-300">coe@ssipmt.edu</p>
                </div>
                <div>
                  <a href="#" className="text-sm text-gray-300 hover:text-cyan-400 transition-colors">CONTACT US</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-gray-700 pt-6 md:pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-xs md:text-sm text-gray-400">
                Copyright © 2025 SSIPMT Raipur | All Rights Reserved
              </p>
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 rounded-full flex items-center justify-center transition-all hover:scale-110" style={{ background: PRIMARY }}>
