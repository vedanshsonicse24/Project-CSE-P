            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
              {achievements.map((achievement, index) => (
                ...
                >
                  ...
                  <div className="text-5xl md:text-6xl font-bold mb-3">{achievement.value}</div>
                  <div className="text-xl md:text-2xl text-white font-semibold" style={{ letterSpacing: '0.01em' }}>{achievement.label}</div>
                </motion.div>
              ))}
            </div>
          </motion.div>
              ...
              {milestones.map((milestone, index) => (
                ...
                >
                  <div className={`flex items-center gap-8 ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                    ...
                    <div className="hidden md:flex w-12 h-12 rounded-full bg-maroon-600 items-center justify-center flex-shrink-0 border-4 border-white shadow-lg z-10">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.div variants={fadeInUp}>
              <Button 
                size="lg" 
                className="bg-maroon-600 hover:bg-maroon-700 text-white text-lg font-bold px-10 py-7 rounded-full shadow-2xl transform hover:scale-105 transition-all"
              >
