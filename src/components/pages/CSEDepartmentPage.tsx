    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-indigo-50">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-10 right-10 w-64 h-64 bg-indigo-600 rounded-full blur-3xl animate-pulse delay-1000"></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <Lightbulb className="w-20 h-20 mx-auto mb-8 animate-bounce text-blue-600" />
            ...
            <motion.button
              className="px-10 py-5 bg-blue-600 text-white font-bold text-lg rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105 hover:bg-blue-700"
