      ...
      <main className="container">
        ...
        <section id="about" className="reveal">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: '1rem', alignItems: 'start' }}>
            <div>
              ...
              <p className="muted">To be a leading student community that inspires technological excellence and ethical innovation. We envision CSA as a launchpad for future engineers and founders — a place where ideas are transformed into meaningful projects that positively impact society.</p>
            ...
            <div className="team-grid">
              <div className="card person" tabIndex={0} style={{ padding: '1.2rem' }}>
                ...
                <div style={{ fontSize: '0.8rem', color: '#6b7280', marginTop: '0.4rem' }}>
                  <div>• Led 5+ technical workshops</div>
                  <div>• National level hackathon winner</div>
                </div>
              </div>
              <div className="card person" tabIndex={0} style={{ padding: '1.2rem' }}>
                ...
                <div style={{ fontSize: '0.8rem', color: '#6b7280', marginTop: '0.4rem' }}>
                  <div>• Published 2 research papers</div>
                  <div>• Google Summer of Code participant</div>
                </div>
              </div>
              <div className="card person" tabIndex={0} style={{ padding: '1.2rem' }}>
                ...
                <div style={{ fontSize: '0.8rem', color: '#6b7280', marginTop: '0.4rem' }}>
                  <div>• Organized 10+ successful events</div>
                  <div>• State level design competition winner</div>
                </div>
              </div>
              <div className="card person" tabIndex={0} style={{ padding: '1.2rem' }}>
                ...
                <div style={{ fontSize: '0.8rem', color: '#6b7280', marginTop: '0.4rem' }}>
                  <div>• Secured 15+ industry partnerships</div>
                  <div>• Cybersecurity certification holder</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <footer>
          <div className="footer-grid container">
            <div style={{ fontSize: '.95rem' }}>© <span id="year"></span> Computer Science Association — SSIPMT</div>
