      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          .floating-filter {
            ...
            transform: none;
            margin: 12px 20px;
            flex-direction: row; /* keep side-by-side on small screens */
            gap: 8px;
            align-items: center;
          }
        }

  /* Ensure input shrinks properly */
  .filter-input { flex: 1 1 auto; min-width: 0; }
      ...
      <div className="faculty-directory-iitk">
        ...
        {/* Contact footer removed as requested */}
      </div>
    </div>
  );
}
