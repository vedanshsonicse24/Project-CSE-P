  ...
  const otherPrograms = [
    {
      ...
      description: "Comprehensive software development and IT management program",
    ...
    },
    {
      ...
      description: "Develop leadership and management skills for business excellence",
      careers: ["Business Manager", "Marketing Executive", "HR Manager", "Financial Analyst"]
    },
    {
      name: "PhD Programs",
      duration: "3-5 Years",
      seats: 20,
      areas: ["Computer Science", "Electronics", "Management"],
      eligibility: "M.Tech/ME/MBA with minimum 60%",
          ...
          >
            <Tabs defaultValue="btech" className="w-full">
              <TabsList className="grid w-full grid-cols-3 mb-12 h-auto">
                ...
                <TabsTrigger value="mtech" className="text-lg py-4">M.Tech & MCA</TabsTrigger>
                <TabsTrigger value="other" className="text-lg py-4">MBA & PhD</TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="other">
                <motion.div 
                  ...
                  animate="animate"
                >
                  {[otherPrograms[1], otherPrograms[2]].map((program, index) => (
                    <motion.div
                      key={index}
                      variants={fadeInUp}
                      whileHover={{ y: -8 }}
