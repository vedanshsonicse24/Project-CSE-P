...
export function UniversityTimelineDemo() {
  const data = [
    {
      title: "2025",
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Launched new AI Research Center and achieved breakthrough in quantum computing applications
          </p>
          <div className="grid grid-cols-2 gap-4">
            ...
            />
            <img
              src="https://images.unsplash.com/photo-1581092918484-8313c4259c7e?w=500&h=300&fit=crop"
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Expanded our Computer Science and Engineering department with new state-of-the-art facilities and industry partnerships.
          </p>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Launched multiple new programs including Machine Learning, Data Science, and Cybersecurity specializations.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <img
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-4">
            Recent milestones and recognitions that mark our commitment to excellence
          </p>
          <div className="mb-8">
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ NAAC A+ Accreditation Received
            </div>
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ 100% Placement Record for CSE Department
            </div>
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ International Research Collaborations Established
            </div>
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ Industry 4.0 Smart Campus Implementation
            </div>
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ 15,000+ Students Enrolled Across All Programs
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <img
              src="https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=500&h=300&fit=crop"
