    ...
    <div className="min-h-screen bg-gradient-to-br from-[#eff6ff] to-[#eef2ff] dark:from-[#0a0e1a] dark:via-[#1a2b46] dark:to-[#0f1724] p-4 md:p-6 lg:p-8">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <Button
          ...
          className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-6 text-lg disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isSubmitting ? (
            <>
