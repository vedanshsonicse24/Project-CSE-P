...
const roleData = [
  {
    ...
    shapes: [
      ...
      { type: "line", width: 150, x: 20, y: 40, rotation: 45, color: "rgba(96, 165, 250, 0.4)" },
      { type: "line", width: 100, x: 60, y: 70, rotation: -30, color: "rgba(249, 115, 22, 0.3)" },
      { type: "pill", width: 120, x: 70, y: 30, rotation: 20, color: "rgba(251, 146, 60, 0.4)" },
    ]
  },
  {
    id: "faculty",
    ...
    shapes: [
      ...
      { type: "line", width: 130, x: 65, y: 65, rotation: -45, color: "rgba(251, 146, 60, 0.5)" },
  ...
  },
  {
    ...
    shapes: [
      ...
      { type: "line", width: 140, x: 15, y: 45, rotation: 50, color: "rgba(96, 165, 250, 0.4)" },
  ...
  return (
    <div className="split-login-page">
      ...
      <div className="split-container">
        ...
        <div className="split-left" style={{ background: currentRole.gradient }}>
        ...
        <div className="split-right">
          <div className="login-form-container">
            ...
            >
              <h2 className="login-form-title" style={{ color: '#1e3a8a' }}>
              ...
              <form onSubmit={handleSubmit} className="login-form">
                ...
                {onNavigateToHome && (
                  <Button
                    ...
                    style={{ borderColor: '#60a5fa', color: '#1e3a8a' }}
                  >
                    Back to Home
                  </Button>
                )}
